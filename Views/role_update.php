    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                ...
                <form action="MainEntryPoint.php?modul=role&fitur=update&id=<?php echo $peran->role_id?>" method="POST">
                    <!-- Nama Role -->
                    <div class="mb-4">
                        ...
                        value="<?php echo htmlspecialchars($peran->role_name)?>">
                    </div>
                    ...
                    <div class="mb-4 text-left">
                        ...
                        <textarea id="role_description" name="role_description"
                                  ...
                                  required><?php echo htmlspecialchars($peran->role_description) ?></textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="role_status" name="role_status"
                                ...
                                required>
                            <option value="1" <?php echo ($peran->role_status == 1) ? 'selected' : ''; ?>>Active
                            </option>
                            <option value="0" <?php echo ($peran->role_status == 0) ? 'selected' : ''; ?>>Inactive
                            </option>
                        </select>
                    </div>
